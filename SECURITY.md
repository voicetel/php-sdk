...
<https://github.com/voicetel/php-sdk/security/advisories/new>).
...
- The SDK uses Guzzle / cURL with TLS 1.2+ and reuses the cURL
  handle's TLS session across requests. If you supply a custom
  Guzzle handler, you are responsible for matching that posture.
...
Out of scope: vulnerabilities in the `voicetel/sdk` Composer package
